    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 max-w-4xl mx-auto my-8">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="flex flex-col justify-center">
          <div className="bg-yellow-50 dark:bg-yellow-900/20 p-6 rounded-lg border border-yellow-100 dark:border-yellow-800 h-full flex items-center">
            <div>
              <h2 className="text-2xl font-bold text-yellow-800 dark:text-yellow-200 mb-4">Support Our Mission</h2>
              <p className="text-yellow-700 dark:text-yellow-300 font-medium text-lg mb-4">
                100% of profits from your contribution will be donated to charitable works through Caritas Internationalis.
              </p>
              <p className="text-yellow-700 dark:text-yellow-300">
                Your generosity helps bring Pope Francis&apos;s vision of mercy and compassion to those most in need around the world.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-6">
          <h2 className="text-2xl font-bold text-gray-800 dark:text-white">Donate now</h2>
